...
//        showToast(context, title, message)
    ...
    fun setOneTimeAlarm(
        ...
        val intet = Intent(context, AlarmReceiver::class.java)
        intet.putExtra(EXTRA_MESSAGE, message)
        intet.putExtra(EXTRA_TYPE, type)
        ...
        val pendingIntent = PendingIntent.getBroadcast(context, ID_ONETIME, intet, 0)
